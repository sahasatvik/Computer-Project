public class SetDemo {
	public static void main (String[] args) {
		/* Create 3 sets with random elements */
		Set a = new Set(10);
		Set b = new Set(10);
		Set c = new Set(10);
		for (int i = 0; i < 10; i++)
		...
		System.out.printf("A - B [%2d] = %s\n",
					Set.difference(a, b).getSize(),
					Set.difference(a, b));
		System.out.printf("B - C [%2d] = %s\n",
					Set.difference(b, c).getSize(),
					Set.difference(b, c));
		System.out.printf("C - A [%2d] = %s\n",
					Set.difference(c, a).getSize(),
					Set.difference(c, a));
	}
}
